...
#[proc_macro_derive(Packet, attributes(packet, pf, packet_enum, pe, pef))]
...
#[proc_macro_error::proc_macro_error]
#[proc_macro_derive(PacketWritable, attributes(pf, packet_enum, pe, pef))]
...
#[proc_macro_error::proc_macro_error]
#[proc_macro_derive(PacketReadable, attributes(pf, packet_enum, pef))]
